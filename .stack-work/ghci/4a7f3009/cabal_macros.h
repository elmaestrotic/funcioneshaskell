...
/* package projectico-0.1.0.0 */
#ifndef VERSION_projectico
#define VERSION_projectico "0.1.0.0"
#endif /* VERSION_projectico */
#ifndef MIN_VERSION_projectico
#define MIN_VERSION_projectico(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projectico */
...
#define CURRENT_COMPONENT_ID "projectico-0.1.0.0-KLZs3YUlm7LBNgfslO2tUO-projectico"
